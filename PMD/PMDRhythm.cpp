...
//  Command "\?" / "\?p"
uint8_t * PMD::SetRhythmInstrumentCommand(uint8_t * si)
{
...
uint8_t * PMD::IncreaseRhythmVolumeCommand(uint8_t * si)
{
...
// Command "\p?"
uint8_t * PMD::SetRhythmOutputPositionCommand(uint8_t * si)
{
    int dl = (*si & 3) << 6;
    int dh = (*si++ >> 5) & 0x07;
