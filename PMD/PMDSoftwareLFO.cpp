...
/** $VER: PMDSoftwareLFO.cpp (2026.01.07) PMD driver (Based on PMDWin code by C60 / Masahiro Kajihara) **/
...
int pmd_driver_t::SetSSGLFO(channel_t * channel)
{
    ...
    if (channel->_ExtendMode & 0x02)
    {
        ...
        int32_t Value = _State._TimerACounter - _Driver._OldTimerACounter;
