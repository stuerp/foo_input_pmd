...
* Fixed: Sign-extension bug that caused relative tempo change commands T± (FC FE) and t± (FC FD) to misbehave. Thanks to [HertzDevil](https://github.com/HertzDevil) for finding the bug.
